...
export default function LandingPage({ onLogin }: LandingPageProps) {
  ...
  if (showLogin || showSignup) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#F3E5D0] via-[#CFE6F5] to-[#e8f4f0] flex items-center flex-jc p-4">
        <motion.div
          layout={false}
        ...
        >
          <Card className="w-full max-w-md p-8 shadow-xl">
            <div className="text-center mb-8">
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-[#A8C3A0] to-[#D9A7A0] rounded-full flex-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F3E5D0] via-[#CFE6F5] to-[#e8f4f0]">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          >
            <div className="w-24 h-24 bg-[#A8C3A0] rounded-full flex-center shadow-2xl">
          ...
          <motion.div
            ...
            className="flex gap-4 flex-wrap flex-jc"
          >
            <Button
              size="lg"
          ...
          {[
            ...
            >
              <Card className="p-6 h-full bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all">
                <div 
                  className="w-14 h-14 rounded-2xl flex-center mb-4 shadow-md" 
